...
self.getByStakeholderId = async (req, res) => {
  const { id } = req.params;
  try {
    const data = await ProjectJointVentureCompany.findAll({
...
self.get = async (req, res) => {
  getRecordById(ProjectJointVentureCompany, req, res);
};

self.save = async (req, res) => {
  saveRecord(ProjectJointVentureCompany, req, res);
};

self.update = async (req, res) => {
  updateRecord(ProjectJointVentureCompany, req, res);
};

self.delete = async (req, res) => {
  deleteRecord(ProjectJointVentureCompany, req, res);
};
