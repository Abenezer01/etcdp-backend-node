...
self.get = async (req, res) => {
  getRecordById(DocumentSubCategory, req, res);
};

self.save = async (req, res) => {
  saveRecord(DocumentSubCategory, req, res);
};

self.update = async (req, res) => {
  updateRecord(DocumentSubCategory, req, res);
};

self.delete = async (req, res) => {
  deleteRecord(DocumentSubCategory, req, res);
};
