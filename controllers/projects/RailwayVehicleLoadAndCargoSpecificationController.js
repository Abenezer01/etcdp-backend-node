const { RailwayVehicleLoadAndCargoSpecification, ProjectMasterData, Sequelize } = require("../../models");
...
self.getAll = async (req, res) => {
  try {
    ...
    const paginatedResult = await paginationHelper(RailwayVehicleLoadAndCargoSpecification , req, whereCondition, includeOptions);
