...
self.get = async (req, res) => {
  getRecordById(RailwayBallastMaterialData , req, res);
};

self.save = async (req, res) => {
  saveRecord(RailwayBallastMaterialData , req, res);
};

self.update = async (req, res) => {
  updateRecord(RailwayBallastMaterialData , req, res);
};

self.delete = async (req, res) => {
  deleteRecord(RailwayBallastMaterialData , req, res);
};
