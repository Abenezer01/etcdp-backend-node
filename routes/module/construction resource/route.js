...
module.exports = function(express) {
    ...
    route.post("/construction-resource-type", ConstructionResourceTypeController.save);
    route.put("/construction-resource-type/:id", ConstructionResourceTypeController.update);
    ...
    route.post("/construction-resource-category", ConstructionResourceCategoryController.save);
    route.put("/construction-resource-category/:id", ConstructionResourceCategoryController.update);
    ...
    route.post("/construction-resource-subcategory", ConstructionResourceSubCategoryController.save);
    route.put("/construction-resource-subcategory/:id", ConstructionResourceSubCategoryController.update);
    ...
    route.post("/construction-resource", ConstructionResourceRegistrationController.save);
    route.put("/construction-resource/:id", ConstructionResourceRegistrationController.update);
    ...
    route.post("/construction-resource-quantity-price", ConstructionResourceQuantityAndPriceController.save);
    route.put("/construction-resource-quantity-price/:id", ConstructionResourceQuantityAndPriceController.update);
